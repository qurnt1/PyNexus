                    ...
                    <>
                        ...
                        <div className="absolute top-24 left-6 z-20 pointer-events-none">
                            ...
                            >
                                <button
                                    onClick={handleReset}
                                    className="glass rounded-lg px-5 h-[58px] flex items-center text-sm font-orbitron text-cta-primary hover:text-white hover:bg-cta-primary/20 border border-cta-primary/50 transition-all"
                                >
                                    ← New Scan
                                </button>
                                <div className="glass rounded-lg px-4 h-[58px] flex flex-col justify-center">
